...
def generate_random_Date(BadgeActivation=False, BadgeDeactivation=False, LastUpdate=False, base_date=None, activation_date=None, next_activation_date=None):
    ...
    if BadgeActivation:
        ...
        # Parse activation date and next activation date for calculations
        ...
        if next_activation_date:
            ...
            next_activation_date = datetime.now()  # Default to now if not provided
        ...
        days_offset = random.randint(1, delta_days - 1) if delta_days > 1 else 1
