...
def gernerate_random_ActivationDate(Deactivate=False):
    pass
...
def generate_profile():
    return {
        ...
        "Badge_ID": random.choice(badge_status),
        "Badge_Type": random.choice(badge_type),
        "Badge_ActivateOn": gernerate_random_ActivationDate(),
        "Badge_DeactivateOn": gernerate_random_ActivationDate(Deactivate=True),

        "Badge_LastUpdatedUTC": random.choice(badge_status),
        "Badge_LastLocationReaderName": random.choice(badge_status),
        "Badge_LastLocationEventType": "Access Granted",

        "Accesslevels_Count": random.choice(badge_status),
        "Badge": random.choice(badge_status),
        "Badge": random.choice(badge_status),
        "Badge": random.choice(badge_status),
    }
