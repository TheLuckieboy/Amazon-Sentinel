...
badge_type = ["Air Employee Seasonal (pic)", "Air Employee (pic)", "Employee (pic)", "Employee 5yr (pic)", "Air Employee 5yr (pic)", "Contractor (pic)", "Air Contractor(pic)"]
...
def generate_randdom_badgeStatus():
    pass

def generate_randdom_employeeStatus():
    EmployeeStatus = random.choice(employee_statuses)
    return EmployeeStatus

def generate_randdom_employeeType():
    EmployeeType = random.choice(employee_types)
    return EmployeeType

def gernerate_random_Date(BadgeActivation=False, BadgeDeactivation=False, LastUpdate=False):
    pass
...
def generate_profile():
    return {
        ...
        "Employee_Type": generate_randdom_employeeType(),
        "Employee_Status": generate_randdom_employeeStatus(),
        ...
        "Badge_Status": random.choice(badge_status),
        "Badge_Type": random.choice(badge_type),
