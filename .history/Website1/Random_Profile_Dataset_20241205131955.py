...
def generate_random_Date(BadgeActivation=False, BadgeDeactivation=False, LastUpdate=False, base_date=None):
...
def generate_profile():
    ...
    for _ in range(badge_count):
        ...
        base_date -= timedelta(days=random.randint(1, 30))  # Adjust by 1-30 days
