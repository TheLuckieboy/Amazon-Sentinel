document.addEventListener("DOMContentLoaded", function () {
    ...
    function displayProfile(profileData) {
        ...
        const AccessLvlData = generateAccessLvlTabHTML_Delayed(profileData)
        ...
        if (badgeButton) {
            badgeButton.addEventListener('click', () => {
                ...
                // Insert delayed content first if no full data
                if (!AccessLvlData) {
                    thirdPanel.innerHTML = generateAccessLvlTabHTML_Delayed(profileData); // Show loading
                }

                // Load full data asynchronously
                setTimeout(() => {
                    if (!AccessLvlData) {
                        AccessLvlData = generateAccessLvlTabHTML(profileData);
                    }
                    thirdPanel.innerHTML = AccessLvlData; // Update with full content
