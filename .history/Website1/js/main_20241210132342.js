document.addEventListener("DOMContentLoaded", function () {
    ...
    function enableSearchFiltering() {
        const tables = document.querySelectorAll('.awsui_table_wih1l_1v07r_198.awsui_table-layout-fixed_wih1l_1v07r_204');
        const searchInputs = document.querySelectorAll('.awsui_input_2rhyz_oflk9_145.awsui_input-type-search_2rhyz_oflk9_286.awsui_input-has-icon-left_2rhyz_oflk9_271');
        ...
        // Ensure the number of search inputs matches the tables
        if (tables.length !== searchInputs.length) {
            console.error('Mismatch between tables and search inputs!');
            return;
        }
    
        // Handle sorting for all tables
        tables.forEach((table) => {
            const headers = table.querySelectorAll('thead tr th');
        ...
        // Handle search filtering for corresponding tables
