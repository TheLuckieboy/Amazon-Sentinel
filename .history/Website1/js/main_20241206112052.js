                                                ...
                                                <div class="awsui_restore-pointer-events_14yj0_1cgl1_356">
                                                    <div style="width: 260px; height: auto; display: flex; align-self: auto; flex-direction: column; justify-content: center; align-items: center; margin: 10px;">
                                                        <div class="awsui_root_18582_7onux_141 awsui_vertical_18582_7onux_188 awsui_vertical-xs_18582_7onux_197">
                                                            <div class="awsui_child_18582_7onux_145"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Amazon_icon.svg/2500px-Amazon_icon.svg.png" alt="Cardholder badge photo" style="max-width: 50%; max-height: 60%; border-radius: 10px; margin: auto; align-items: center; display: flex; justify-content: center;"></div>
                                                            <div class="awsui_child_18582_7onux_145">
                                                                    ...
                                                                    <div class="awsui_root_18582_7onux_141 awsui_vertical_18582_7onux_188 awsui_vertical-xs_18582_7onux_197">
                                                                        ...
                                                                        <div class="awsui_child_18582_7onux_145">
                                                                            <div class="awsui_root_2rhyz_oflk9_141 awsui_input-container_2rhyz_oflk9_309">
                                                                                <input class="awsui_input_2rhyz_oflk9_145 awsui_input-readonly_2rhyz_oflk9_195" autocomplete="on" readonly="" type="text" value="${profileData.employeeLogin || ''}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
