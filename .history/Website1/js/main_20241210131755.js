document.addEventListener("DOMContentLoaded", function () {
    ...
    function enableSorting() {
        ...
        tables.forEach((table) => {
            ...
            const searchInput = document.querySelectorAll('.awsui_input_2rhyz_oflk9_145.awsui_input-type-search_2rhyz_oflk9_286.awsui_input-has-icon-left_2rhyz_oflk9_271');
    ...
    function enableSearchFiltering() {
        const searchInput = document.querySelector('.awsui_input_2rhyz_oflk9_145.awsui_input-type-search_2rhyz_oflk9_286.awsui_input-has-icon-left_2rhyz_oflk9_271');
        const tables = document.querySelectorAll('.awsui_table_wih1l_1v07r_198.awsui_table-layout-fixed_wih1l_1v07r_204');
        
        if (!searchInput || tables.length === 0) {
            console.error('Search input or tables not found!');
            return;
        }
