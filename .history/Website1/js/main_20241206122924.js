document.addEventListener("DOMContentLoaded", function() {
    ...
    function displayProfile(profileData) {
        // Find the root container where sections are located
        const rootElement = document.querySelector('.awsui_root_18582_7onux_141');
        ...
        // Check if a profile section already exists to avoid duplicates
        let profileSection = rootElement.querySelector('.profile-section');

        if (!profileSection) {
            // Create a new section container for the profile
            profileSection = document.createElement('div');
            profileSection.classList.add('awsui_child_18582_7onux_145', 'profile-section'); // Add your specific class and a custom identifier
            rootElement.appendChild(profileSection);
        } else {
            // Clear the existing profile content for a new search
