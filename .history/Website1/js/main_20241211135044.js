document.addEventListener("DOMContentLoaded", function () {
    ...
    function performSearch() {
        ...
        if (searchButton) {
            searchButton.classList.add('awsui_disabled_vjswe_4v1qr_289');
        }
    ...
    function displayProfile(profileData) {
        ...
        const BadgeData = generateBadgeTabHTML_Delayed(profileData)
        let AccessLvlData = generateAccessLvlTabHTML_Delayed(profileData)
            ...
            <div>
                <div class="awsui_header-controls_wih1l_1v07r_321 awsui_variant-container_wih1l_1v07r_215">
                    <div class="awsui_root_2qdw9_kiqfw_177 awsui_root-variant-h2_2qdw9_kiqfw_219">
                        <div class="awsui_main_2qdw9_kiqfw_238">
                            <div class="awsui_title_2qdw9_kiqfw_294 awsui_title-variant-h2_2qdw9_kiqfw_306">
                                <h2 class="awsui_heading_2qdw9_kiqfw_370 awsui_heading-variant-h2_2qdw9_kiqfw_386"><span data-analytics-funnel-key="substep-name" class="awsui_heading-text_2qdw9_kiqfw_397 awsui_heading-text_105ke_268sp_5 awsui_heading-text-variant-h2_2qdw9_kiqfw_408" id="heading8903-1733781154939-6737">Accesslevels</span><span class="awsui_counter_2qdw9_kiqfw_425"> (0)</span></h2></div>
                            <div class="awsui_actions_2qdw9_kiqfw_262 awsui_actions-variant-h2_2qdw9_kiqfw_274 awsui_actions-centered_2qdw9_kiqfw_267">
                                <div class="awsui_root_18582_7onux_141 awsui_horizontal_18582_7onux_156 awsui_horizontal-xs_18582_7onux_166">
                                    <div class="awsui_child_18582_7onux_145">
        ...
        if (accessLevelButton) {
            accessLevelButton.addEventListener('click', () => {
                ...
                // Generate non-delayed content
                const newAccessLvlData = generateAccessLvlTabHTML(profileData);

                // Replace the thirdPanel's content
                thirdPanel.innerHTML = `
                <div class="awsui_tabs-content_14rmt_pykih_542 awsui_tabs-content-active_14rmt_pykih_552" role="tabpanel" id="awsui-tabs-12473-1733498994778-9458-third-panel" tabindex="0" aria-labelledby="awsui-tabs-341-1733779044157-3489-third">
                    <div class="awsui_root_wih1l_1v07r_149 awsui_root_14iqq_zuudq_185 awsui_variant-default_14iqq_zuudq_229" data-selection-root="true" data-analytics-task-interaction-id="8898-1733781154939-4161">
                        <div id="8901-1733781154939-6991" class="awsui_content-wrapper_14iqq_zuudq_304">
                            ${AccessLevel_TabHeader_HTML}
                            <div class="awsui_content_14iqq_zuudq_304">
                                <div class="awsui_content-inner_14iqq_zuudq_492 awsui_content-inner_1mwlm_oyjaq_5 awsui_with-header_14iqq_zuudq_499">
                                    <div class="awsui_wrapper_wih1l_1v07r_208 awsui_variant-container_wih1l_1v07r_215 awsui_has-header_wih1l_1v07r_221">
                                        <div class="awsui_wrapper-content-measure_wih1l_1v07r_215"></div>
                                        ${newAccessLvlData}
                                        <span class="awsui_tracker_x7peu_12e0g_249"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    function generateAccessLvlTabHTML(profileData) {
        ...
        // Combine the table header, rows, and footer
        return `
            <table class="awsui_table_wih1l_1v07r_198 awsui_table-layout-fixed_wih1l_1v07r_204" role="table" aria-rowcount="${profileData.AccessLvl.length + 1}" data-analytics-performance-mark="8897-1733781154939-4451" data-analytics-task-interaction-id="8898-1733781154939-4161" aria-labelledby="heading8903-1733781154939-6737">
                <thead class="awsui_thead-active_wih1l_1v07r_355">
                    ${accessHeader}
                </thead>
                <tbody>
    ...
    function enableSorting() {
        ...
        const searchInputs = document.querySelectorAll('.awsui_input_2rhyz_oflk9_145.awsui_input-type-search_2rhyz_oflk9_286');
        ...
        searchInputs.forEach((searchInput, index) => {
            // Pair each search input with its corresponding table
            const table = tables[index]; // Assuming a 1-to-1 mapping between search inputs and tables
    
            if (!table) {
                console.error(`No table found for search input at index ${index}`);
                return;
            }
