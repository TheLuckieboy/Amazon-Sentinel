document.addEventListener("DOMContentLoaded", function() {
    ...
    function performSearch() {
        ...
        if (inputValue.trim()) {
            ...
            // You can add code here to display the profile or perform any other action
            // Example: Load profile data using the input value (send it to a function, API call, etc.)
