    ...
    function displayProfile(profileData) {
        ...
        setTimeout(() => {
            if (isSecondPanelActive) {
                ...
                ${BadgeData}
                `;
                Number_Badges.textContent = `(${BadgeCount})`;
            } else {
                tableBody3.innerHTML = `
                ${AccessLvlData}
                `;

                Number_AccessLvls.textContent = `(${AccessLvlData})`;
            }
        }, 1000); // 1-second delay
        ...
        if (badgeButton) {
            badgeButton.addEventListener('click', () => {
                ...
                setTimeout(() => {
                    ...
                    ${BadgeData}
                    `;
                    Number_Badges.textContent = `(${Badge_Count})`;
                }, 1000); // 1-second delay
            });
        }
        ...
        if (accessLevelButton) {
            accessLevelButton.addEventListener('click', () => {
                ...
                setTimeout(() => {
                    ...
                    ${AccessLvlData}
                    `;
                    Number_AccessLvls.textContent = `(${AccessLvl_Count})`;
                }, 1000); // 1-second delay
            });
        }
