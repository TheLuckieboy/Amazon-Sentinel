document.addEventListener("DOMContentLoaded", function() {
    ...
    function displayProfile(profileData) {
        ...
        // Generate a random cartoon avatar
        const randomSeed = Math.random().toString(36).substring(2, 15); // Generate a random seed
        const avatarUrl = `https://avatars.dicebear.com/api/croodles/${randomSeed}.svg`;
                                                ...
                                                <div class="awsui_restore-pointer-events_14yj0_1cgl1_356">
                                                    <div style="width: 260px; height: auto; display: flex; align-self: auto; flex-direction: column; justify-content: center; align-items: center; margin: 10px;">
                                                        <div class="awsui_root_18582_7onux_141 awsui_vertical_18582_7onux_188 awsui_vertical-xs_18582_7onux_197">
                                                            <div class="awsui_child_18582_7onux_145"><img src=${avatarUrl} alt="Cardholder badge photo" style="max-width: 50%; max-height: 60%; border-radius: 10px; margin: auto; align-items: center; display: flex; justify-content: center;"></div>
                                                            <div class="awsui_child_18582_7onux_145">
