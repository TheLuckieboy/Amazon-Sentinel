...
def generate_profile():
    global Region, BuildingLocation, ActiveBadge
    ...
    Tenure = str(random.randint(1, 20)) + " years," + str(random.randint(1, 12)) + " months," + str(random.randint(1, 28)) + " days"
    ...
    for _ in range(badge_count):
        badges.append({
            ...
            "Badge_LastLocationReaderName": f"{(BuildingLocation.split('/')[0])} {random.choice(badge_locationRead)}",
