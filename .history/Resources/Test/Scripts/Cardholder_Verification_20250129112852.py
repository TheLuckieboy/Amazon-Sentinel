...
def Cardholder_Failsafe_GeneralError(driver, Trigger=None):
...
def CardHolder_WaitFor_Loading(driver, MainProfile=False, Element=None, settings=None, StopFunctionException=None, check_stop_event=None, stop_event=None):
    try:
        ...
        print(f"Massive Print: {driver}, {MainProfile}, {Element}, {settings}, {StopFunctionException}, {check_stop_event}, {stop_event}, {Status1}, {LoadingComplete}, {Time}")

        for attempt in range(30):
            print("Trigger1")
            check_stop_event(stop_event)
            print("Trigger2")
            Cardholder_Failsafe_GeneralError(driver, "wait")
            print("Trigger3")
            if MainProfile:
                print("Trigger4")
                ...
                if 'awsui_disabled_vjswe' in class_name:
                    ...
                    print(f"{Status1}, {LoadingComplete}")
                    time.sleep(0.25)
