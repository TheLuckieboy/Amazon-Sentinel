        ...
        if Quip_Database and not Excel_Database:
            ...
            if CommandLineResult == "skip":
                ...
                for LoadProfileAttempt in range(3):
                    ContinueStatus1, Result = CardHolder_WaitFor_Loading(driver, MainProfile=True, Element=SearchButton_Element, StopFunctionException=StopFunctionException, check_stop_event=check_stop_event, stop_event=stop_event)
                    if ContinueStatus1:
                        if Result:
                            ContinueStatus2, ProfileLoaded = Cardholder_Verify_ProfileLoaded()
                            if ContinueStatus2:
                        ...
                        print(f"ContinueStatus: {ContinueStatus1}")
                        return False
                # Bad EID
