...
Quip_Utilities_File = Import_File("Quip_Utilities_File", resource_path(os.path.join("Resources/Utilities/Quip_Utilities_File.zip")))
CardHolder_Utilities_File = Import_File("CardHolder_Utilities_File", resource_path(os.path.join("Resources/Scripts/Cardholder_Verification.zip")))
