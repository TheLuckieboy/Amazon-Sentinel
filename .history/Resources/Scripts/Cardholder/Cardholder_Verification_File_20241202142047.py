...
from main import utilities_file as Utilities_File
...
print("Hi2")
Quip_Utilities_File = Import_File("Quip_Utilities_File", "Resources/Test/Utilities/Quip_Utilities_File.zip")
CardHolder_Utilities_File = Import_File("CardHolder_Utilities_File", "Resources/Test/Scripts/Cardholder_Verification.zip")
...
CardHolder_ClickOn_CardholderTab = getattr(CardHolder_Utilities_File, "CardHolder_ClickOn_CardholderTab", None)
