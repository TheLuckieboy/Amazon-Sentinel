...
from Resources.Utilities.Quip_Utilities_File import Quip_GetInfo_CellText, Quip_ClickOn_Cell, Quip_Check_CommandLine, Quip_Color_Cells
from Resources.Scripts.Cardholder.CardHolder_Utilities_File import (CardHolder_Paste_EID, CardHolder_Paste_Login, CardHolder_General_Failsafe,
                                       CardHolder_WaitFor_Loading, CardHolder_ClickOn_BadgeTab, CardHolder_ClickOn_CardholderTab,
                                       CardHolder_ClickOn_AccessLvlTab, CardHolder_GetInfo_ProfileInfo, Cardholder_Failsafe_GeneralError,
                                       CardHolder_GetInfo_BadgeInfo, CardHolder_GetInfo_AccessLvlInfo, CardHolder_GetElement_SearchButton)
...
# Load the utilities_file
quip_utilities_file = Import_File("Quip_Utilities_File", "Resources/Test/Utilities/Utilities_File.zip")
    ...
    try:
        ...
        if Quip_Database and not Excel_Database:
            ...
            if CommandLineResult == "skip":
                ...
                SearchButton_Element = CardHolder_GetElement_SearchButton(driver, stop_event=stop_event)
                ...
                ContinueStatus, Result = CardHolder_WaitFor_Loading(driver, MainProfile=True, Element=SearchButton_Element, settings=settings, stop_event=stop_event)
                if ContinueStatus:
                    if Result:
