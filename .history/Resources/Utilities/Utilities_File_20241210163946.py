...
try:
    Cardholder_Verification_File = Import_File("Cardholder_Verification_File", resource_path(os.path.join("Resources/Scripts/Cardholder_Verification.zip")))
...
try:
    Skyline_Terminate_AA_File = Import_File("Skyline_Terminate_AA_File", "Resources/Scripts/Skyline_Terminate_AA.zip")
