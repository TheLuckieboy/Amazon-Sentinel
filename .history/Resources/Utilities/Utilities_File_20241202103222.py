...
Cardholder_Verification_File = Import_File("Cardholder_Verification_File", "Resources/Test/Scripts/Cardholder/Cardholder_Verification.zip")
Skyline_Terminate_AA_File = Import_File("Skyline_Terminate_AA_File", "Resources/Test/Scripts/Cardholder/Cardholder_Verification.zip")
