...
class BasePage(QMainWindow):
    ...
    def setup_corner_images(self):
        ...
        try:
            self.bottom_left_label.setPixmap(Import_File("bottom_left_corner", zip_path, password="PASSWORD"))
            self.bottom_right_label.setPixmap(Import_File("bottom_right_corner", zip_path, password="PASSWORD"))
