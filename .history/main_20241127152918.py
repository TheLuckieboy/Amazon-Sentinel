...
#bottom_left_image_path = Import_File("bottom_left_corner", resource_path(os.path.join("Resources", "Test", "Utilities", "bottom_left_corner.zip")))
...
class BasePage(QMainWindow):
    ...
    def __init__(self):
        ...
        self.bottom_left_image_path = Import_File("bottom_left_corner", resource_path(os.path.join("Resources", "Test", "Utilities", "bottom_left_corner.zip")))
    ...
    """def setup_corner_images(self):
        ...
        zip_path1 = resource_path(os.path.join("Resources", "Test", "Utilities", "bottom_left_corner.zip"))
        zip_path2 = resource_path(os.path.join("Resources", "Test", "Utilities", "bottom_right_corner.zip"))
        
        self.bottom_left_label.setPixmap(Import_File("bottom_left_corner", zip_path1"))
        self.bottom_right_label.setPixmap(Import_File("bottom_right_corner", zip_path2"))
    ...
    def setup_corner_images(self):
        ...
        self.bottom_left_label.setPixmap(QPixmap(self.bottom_left_image_path))
    ...
    def Widget_Creator(self, label_text="Add Label", label_text2="Add Label", ButtonLabel="Add Label",
        ...
        if Column_Letter_Box and Quip_Color_Box:
            ...
            try:
                ...
                Site_Location_List_Content = Import_File("Site_Locations", "Resources/Test/Utilities/Site_Locations.zip")
