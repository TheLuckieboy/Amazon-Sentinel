...
class FunctionsGUI(BasePage):
    ...
    def Plugin_Settings(self):
        zip_path, password, temp_dir = "Resources/Test/Utilities/Utilities_File.py.zip", "PASSWORD", "./temp"
        ...
        if os.path.exists(temp_dir):
            shutil.rmtree(temp_dir)  # This removes the entire temp folder and its contents
            print(f"Temporary files and folder {temp_dir} have been deleted.")
