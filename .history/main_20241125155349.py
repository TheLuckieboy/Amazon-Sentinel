    ...
    def Widget_Creator(self, label_text="Add Label", label_text2="Add Label", ButtonLabel="Add Label",
        ...
        if Column_Letter_Box and Quip_Color_Box:
            ...
            try:
                ...
                Site_Location_List_Content = Import_File(
                    "Site_Locations",
                    "Resources/Test/Site_Locations.txt.zip",
                    Text_File=True
                )
...
if __name__ == "__main__":
    ...
    try:
        ...
        stylesheet = Import_File("styles", "Resources/Test/styles.qss.zip", Text_File=True, QSS_File=True)
        if stylesheet:
            app.setStyleSheet(stylesheet)
    except FileNotFoundError:
