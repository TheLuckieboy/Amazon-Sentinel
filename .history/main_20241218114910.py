...
class BasePage(QMainWindow):
    ...
    def paintEvent(self, event):
        ...
        painter.drawRect(0, 0, BORDER_THICKNESS, rect.height())  
        painter.drawRect(rect.width() - BORDER_THICKNESS, 0, BORDER_THICKNESS, rect.height())  
        painter.drawRect(0, 0, rect.width(), BORDER_THICKNESS)  
        painter.drawRect(0, rect.height() - BORDER_THICKNESS, rect.width(), BORDER_THICKNESS)  
    ...
    def toggle_sidebar_state(self):
        ...
        self.sidebar_expanded_changed.emit(self.sidebar_expanded)  
        self.toggle_sidebar()
...
class FunctionsGUI(BasePage):
    ...
    def addComboBox(self, layout, widget, itemList1, itemList2=None, Checkmark=False):
        ...
        if itemList2:
            ...
            completer2.popup().setStyleSheet("background-color: 
    ...
    def addLineEdit(self, layout, widget, Line_Edit, IntValidator, StrValidator):
        def StrValidator_function():
            ...
            if capitalized_text in ("Ctrl+C", "Ctrl+V", "Alt+Tab", "Shift+Tab", "Alt+F4"):
                ...
                widget.line_edit.setText(capitalized_text)  
