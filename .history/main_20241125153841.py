...
def Import_File(File_Name, zip_path, Python_File=False, Text_File=False, QSS_File=False):
    ...
    extract_zip(zip_path, "./temp", Zip_Password)

    file_extension = "py" if Python_File else "txt" if Text_File else "qss"

    # Locate and decrypt the file
    encrypted_path = Path("./temp") / f"{File_Name}.{file_extension}.enc"
...
utilities_file = Import_File("Utilities_File", "Resources/Test/Utilities/Utilities_File.zip", Python_File=True)
...
if __name__ == "__main__":
    ...
    try:
        ...
        stylesheet = Import_File("styles", "Resources/Test/styles.zip", Text_File=True, QSS_File=True)
        if stylesheet:
            app.setStyleSheet(stylesheet)
    except FileNotFoundError:
