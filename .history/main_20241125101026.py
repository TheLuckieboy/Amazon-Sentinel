...
class FunctionsGUI(BasePage):
    ...
    def Plugin_Settings(self):
        # Assuming the decrypted Utilities_File is in a temp directory
        decrypted_path = "./temp/Utilities_File.py"
        module_name = "Utilities_File"

        # Dynamically load the module
        utilities_module = dynamic_import(decrypted_path, module_name)

        # Access the Plugins function
        Plugins = utilities_module.Plugins
