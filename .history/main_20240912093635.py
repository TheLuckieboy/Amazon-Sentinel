import pyautogui, threading, keyboard, time, json, string, pyperclip, logging, datetime, os, sys
...
class BasePage(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Sentinel V0.0.1")
        # self.setMinimumSize(1202, 310)
        # self.setMaximumSize(1920, 1080)
        self.setFixedSize(1280, 720)
        self.setWindowIcon(QIcon(resource_path(os.path.join("Resources", "Raw Files", "Icon.png"))))
    ...
    def setup_sidebar_buttons(self):
        icons = [
            (resource_path(os.path.join("Resources", "Raw Files", "BurgerMenuIcon.png")), "BurgerMenuButton"),
            (resource_path(os.path.join("Resources", "Raw Files", "FunctionsIcon.png")), "functionsButton", 0),
            (resource_path(os.path.join("Resources", "Raw Files", "HelpIcon.png")), "helpButton", 1),
            (resource_path(os.path.join("Resources", "Raw Files", "ExtraIcon.png")), "extraButton", 2),
        ]

        icons_with_desc = [
            (resource_path(os.path.join("Resources", "Raw Files", "BurgerMenuIconWithDescription.png")), "BurgerMenuButton"),
            (resource_path(os.path.join("Resources", "Raw Files", "FunctionsIconWithDescription.png")), "functionsButton", 0),
            (resource_path(os.path.join("Resources", "Raw Files", "HelpIconWithDescription.png")), "helpButton", 1),
            (resource_path(os.path.join("Resources", "Raw Files", "ExtraIconWithDescription.png")), "extraButton", 2),
        ]
    ...
    def setup_corner_images(self):
        ...
        bottom_left_image_path = resource_path(os.path.join("Resources", "Raw Files", "Border", "bottom_left_corner.png"))
        bottom_right_image_path = resource_path(os.path.join("Resources", "Raw Files", "Border", "bottom_right_corner.png"))
    ...
    def Execution_Output(self):
        ...
        def Function_Section():
            ...
            def Confirm_Function_Image():
                ...
                red_pixmap = QPixmap(resource_path(os.path.join("Resources", "Raw Files", "ConfirmedRed.png")))
                ...
                green_pixmap = QPixmap(resource_path(os.path.join("Resources", "Raw Files", "ConfirmedGreen.png")))
