...
class BasePage(QMainWindow):
    ...
    """def setup_corner_images(self):
        ...
        try:
            self.bottom_left_label.setPixmap(Import_File("bottom_left_corner", zip_path1, password="PASSWORD"))
            self.bottom_right_label.setPixmap(Import_File("bottom_right_corner", zip_path2, password="PASSWORD"))
    ...
    def setup_corner_images(self):
        ...
        bottom_left_image_path = resource_path(os.path.join("Resources", "Utilities", "Images", "bottom_left_corner.png"))
        bottom_right_image_path = resource_path(os.path.join("Resources", "Utilities", "Images", "bottom_right_corner.png"))
