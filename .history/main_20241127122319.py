...
def decrypt_file(encrypted_path: Path, output_folder: Path, password: str):
    try:
        with open(encrypted_path, 'rb') as enc_file:
            ...
            # Derive the original file name with extension
            original_file_name = encrypted_path.name.replace(".enc", "")
            output_file = output_folder / original_file_name
...
def Import_File(File_Name: str, zip_path: str, password="PASSWORD", temp_dir="./temp"):
    try:
        ...
        print(decrypted_path.name)
        print(decrypted_path.stem)
        print(decrypted_path.suffix)
