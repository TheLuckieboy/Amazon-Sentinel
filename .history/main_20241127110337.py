...
def Import_File(File_Name, zip_path, Zip_Password="PASSWORD", File_Password="PASSWORD", temp_dir="./temp"):
    ...
    try:
        ...
        # Decrypt the file
        decrypted_path = decrypt_file(encrypted_path, File_Password)
...
utilities_file = Import_File("Utilities_File", "Resources/Test/Utilities/Utilities_File.py.zip", Python_File=True)
    ...
    def Widget_Creator(self, label_text="Add Label", label_text2="Add Label", ButtonLabel="Add Label",
        ...
        if Column_Letter_Box and Quip_Color_Box:
            ...
            try:
                ...
                Site_Location_List_Content = Import_File("Site_Locations", "Resources/Test/Utilities/Site_Locations.txt.zip", Text_File=True)
...
if __name__ == "__main__":
    ...
    try:
        ...
        stylesheet = Import_File("styles", "Resources/Test/Utilities/styles.qss.zip", QSS_File=True)
        if stylesheet:
            app.setStyleSheet(stylesheet)
    except FileNotFoundError:
